...
class HorizonItemDecoration_Depressed : RecyclerView.ItemDecoration {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (holder is HorizonAdapter.TitleHolder) {
            ...
            val measureWidth = View.MeasureSpec.makeMeasureSpec(currentTitleView.width, View.MeasureSpec.AT_MOST)
            val measuredHeight = View.MeasureSpec.makeMeasureSpec(currentTitleView.height, View.MeasureSpec.AT_MOST)
            currentTitleView.measure(measureWidth, measuredHeight)
