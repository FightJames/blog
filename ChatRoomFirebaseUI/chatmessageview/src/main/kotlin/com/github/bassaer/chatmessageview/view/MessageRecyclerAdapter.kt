...
class MessageRecyclerAdapter(context: Context, resource: Int, private var objects: List<Any>, private var attribute: Attribute) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
